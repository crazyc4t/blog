...
### What is TeX?
]he original system made by Donald Knuth was called TeX, what TeX do is to take a document in plain text and convert it to a beutifully typeset document with the highest quality possible, with a lot of in-built commands available for writing beutiful math equations, writing with the right fonts specific words and so on,  but TeX was still quite basic, until LaTeX came by...
...
### pdfTeX & pdfLaTeX
The original Tex converted the .tex files into a .dvi (DeVice Independent format) later on pdfTeX being created by Hàn Thế Thành for his PhD thesis which converted .tex to .pdf being a great upgrade since pdf allowed things like hyperlinks, metadata, modern image formats, etc...
